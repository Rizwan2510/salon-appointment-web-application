...
public class KeycloakUserService {
    ...
    private static final String CLIENT_ID = "salon-portal-client"; // Replace with your client ID
    private static final String CLIENT_SECRET = "prqjrvceWQTyqFPsYy03C8TaQEwy6cwU"; // Replace with your client secret
    private static final String GRANT_TYPE = "password";
    private static final String scope = "openid email profile"; // Adjust grant type if necessary
    private static final String username = "rizwan";
    private static final String password = "admin";
    private static  final String clientId = "00f57a24-54f0-4ac9-9f33-baeba1e3bc09";
